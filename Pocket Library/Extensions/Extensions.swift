...
extension UIView {
    ...
    func karakteristikatCollView(collectionView: UICollectionView) {
        
        collectionView.layer.shadowColor = UIColor.brown.cgColor
    ...
    func karakteristikatEFotos(foto: UIImageView) {
